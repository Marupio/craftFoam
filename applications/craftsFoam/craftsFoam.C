...
Description
    An object-oriented implementation of ADM1 (anaerobic digester model no. 1).
...
#include "craftsFoamSolve.H"

#define craftsCaseAndSolveCommand(matrixSize)                                 \
        case matrixSize:                                                      \
            solve<matrixSize>(runTime, mesh, phi, U, p);                      \
            break;
...
#           include "VectorNRunMacro.H"
            ...
            FatalErrorIn("craftsFoam")
                ...
                << "Ensure you matrix size meets one of these, or define the "
