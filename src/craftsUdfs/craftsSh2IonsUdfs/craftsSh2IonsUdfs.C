...
Foam::label Foam::craftsSh2IonsUdfs<matrixSize>::getIons()
{
    ...
    // const ref only for other variables: varName.evaluateField()
    ...
    forAll(test, cellIndex)
    {
        ...
        {
            WarningIn("craftsSh2IonsUdfs::getIons")
    ...
    for (label i(1); i < maxIter; i++)
    {
        ...
        if ((model.calculateRms(numerator) / scaleFactor) < convergence)
        {
            iter--;
            break;
        }
...
template<int matrixSize>
Foam::craftsSh2IonsUdfs<matrixSize>::craftsSh2IonsUdfs
(
...
template<int matrixSize>
void Foam::craftsSh2IonsUdfs<matrixSize>::initializeTimestep()
{}


template<int matrixSize>
void Foam::craftsSh2IonsUdfs<matrixSize>::applyVariableLimits()
{
...
template<int matrixSize>
void Foam::craftsSh2IonsUdfs<matrixSize>::initializeImplicitLoop()
{}


template<int matrixSize>
Foam::label Foam::craftsSh2IonsUdfs<matrixSize>::implicitLoop()
{
    label returnMe(0);
    ...
    switch (ionsError)
    {
        default:
            // Unknown value
            FatalErrorIn("craftsSh2IonsUdfsWithGas::implicitLoop")
...
template<int matrixSize>
void Foam::craftsSh2IonsUdfs<matrixSize>::finalizeImplicitLoop()
{}


template<int matrixSize>
void Foam::craftsSh2IonsUdfs<matrixSize>::finalizeTimestep()
{}


template<int matrixSize>
void Foam::craftsSh2IonsUdfs<matrixSize>::saveState(const label slot)
{}


template<int matrixSize>
void Foam::craftsSh2IonsUdfs<matrixSize>::clearState(const label slot)
{}


template<int matrixSize>
void Foam::craftsSh2IonsUdfs<matrixSize>::loadState(const label slot)
{}


template<int matrixSize>
Foam::label Foam::craftsSh2IonsUdfs<matrixSize>::nStates() const
{
    return -1;
}
...
template<int matrixSize>
bool Foam::craftsSh2IonsUdfs<matrixSize>::validState(const label slot) const
{
    return true;
}
