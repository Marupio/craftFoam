...
#include "craftsSh2IonsGasUdfs.H"
...
Foam::label Foam::craftsSh2IonsGasUdfs<matrixSize>::getIons()
{
    ...
    forAll(test, cellIndex)
    {
        ...
        {
            WarningIn("craftsSh2IonsGasUdfs::getIons")
...
template<int matrixSize>
Foam::craftsSh2IonsGasUdfs<matrixSize>::craftsSh2IonsGasUdfs
(
...
template<int matrixSize>
void Foam::craftsSh2IonsGasUdfs<matrixSize>::initializeTimestep()
{
...
template<int matrixSize>
void Foam::craftsSh2IonsGasUdfs<matrixSize>::applyVariableLimits()
{
...
template<int matrixSize>
void Foam::craftsSh2IonsGasUdfs<matrixSize>::initializeImplicitLoop()
{
...
template<int matrixSize>
Foam::label Foam::craftsSh2IonsGasUdfs<matrixSize>::implicitLoop()
{
    label returnMe(0);
    ...
    switch (gasError)
    {
        default:
            // Unknown value
            FatalErrorIn("craftsSh2IonsGasUdfs::implicitLoop")
    ...
    switch (ionsError)
    {
        ...
        case -4: // funtion hook internal failure - handled same as -3
            if (outputFunctionHooksSummary_)
            {
                Info << "functionHooksSummary: gasModel autoSolver [ionModel="
                    << ionsError << "]" << endl;
            }
            return ionsError;
            returnMe = -3;
...
template<int matrixSize>
void Foam::craftsSh2IonsGasUdfs<matrixSize>::finalizeImplicitLoop()
{
...
template<int matrixSize>
void Foam::craftsSh2IonsGasUdfs<matrixSize>::finalizeTimestep()
{
...
template<int matrixSize>
void Foam::craftsSh2IonsGasUdfs<matrixSize>::saveState(const label slot)
{
...
template<int matrixSize>
void Foam::craftsSh2IonsGasUdfs<matrixSize>::clearState(const label slot)
{
...
template<int matrixSize>
void Foam::craftsSh2IonsGasUdfs<matrixSize>::loadState(const label slot)
{
...
template<int matrixSize>
Foam::label Foam::craftsSh2IonsGasUdfs<matrixSize>::nStates() const
{
...
template<int matrixSize>
bool Foam::craftsSh2IonsGasUdfs<matrixSize>::validState(const label slot) const
{
